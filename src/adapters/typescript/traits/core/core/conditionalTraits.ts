...
export type Strictly<Any> = e.IsUntyped<Any> extends true
  ? never
  : [Any] extends [true]
  ? true
  : false;
// noinspection JSUnusedGlobalSymbols
export type Loosely<Any> = e.IsNever<Any> extends true
  ? never
  : e.IsUntyped<Any> extends true
  ? true
  : [Any] extends [false]
  ? false
  : true;
...
// noinspection JSUnusedGlobalSymbols
export type ToBoolean<Any> = e.IsMaybeExistent<Any> extends true
  ? e.Purify<Any> extends false
    ? false
    : boolean
  : e.IsExistent<Any> extends true
  ? Any extends false
    ? false
    : boolean extends Any
    ? boolean
...
export type If<Condition, This, IfNotThat> = boolean extends ToBoolean<
  Condition
>
  ? This | IfNotThat
  : ToBoolean<Condition> extends true
  ? This
  : IfNotThat;
...
// noinspection JSUnusedGlobalSymbols
export type Maybe<Any> = boolean extends ToBoolean<Any> ? true : false;

// https://stackoverflow.com/a/52473108/3570903
type IsExactlyGeneric<This, Type> = (<A>() => A extends This
  ? true
  : false) extends <A>() => A extends Type ? true : false
  ? true
  : false;

type IsExactlyExtends<This, Type> = e.IsAny<This> extends true
  ? e.IsAny<Type> extends true
    ? true
    : false
  : e.IsAny<Type> extends true
  ? false
...
// noinspection JSClassNamingConvention, JSUnusedGlobalSymbols
export type IsExactly<This, Type, UseExtends = never> = IsNever<
  UseExtends
> extends true
  ? IsExactlyGeneric<e.Compute<This>, e.Compute<Type>>
  : IsExactlyExtends<This, Type>;

// noinspection JSUnusedGlobalSymbols
export type IsMaybeExactly<This, Type> = e.IsAny<This> extends true
  ? true
  : e.IsUnknown<This> extends true
  ? true
  : e.IsNever<This> extends true
  ? false
  : e.IsNever<Type> extends true
  ? false
  : e.IsNever<Exclude<This, Type>> extends false
  ? IsExactly<Extract<This, Type>, Type> extends true
    ? true
    : false
  : false;
// noinspection JSUnusedGlobalSymbols
export type IsMaybe<This, Type> = IsMaybeExactly<This, Type> extends true
  ? true
  : e.IsNever<Exclude<This, Type>> extends false
  ? e.IsNever<Extract<This, Type>> extends false
    ? true
    : false
  : false;

// noinspection JSUnusedGlobalSymbols
export type IsGreaterOrEqual<This, Type> = e.IsNever<This> extends true
  ? e.IsNever<Type>
  : e.IsNever<Type> extends true
  ? false
  : IsMaybe<This, Type> extends true
  ? boolean
  : [This] extends [Type]
  ? true
  : false;
// noinspection JSUnusedGlobalSymbols
export type IsGreater<This, Type> = e.IsNever<This> extends true
  ? false
  : e.IsNever<Type> extends true
  ? false
  : IsMaybeExactly<This, Type> extends true
  ? false
  : IsMaybe<This, Type> extends true
  ? boolean
  : [This] extends [Type]
  ? Not<IsExactly<This, Type>>
  : false;
// noinspection JSUnusedGlobalSymbols
export type IsLesserOrEqual<This, Type> = e.IsNever<This> extends true
  ? e.IsNever<Type>
  : e.IsNever<Type> extends true
  ? false
  : IsMaybe<Type, This> extends true
  ? boolean
  : [Type] extends [This]
  ? true
  : false;
// noinspection JSUnusedGlobalSymbols
export type IsLesser<This, Type> = e.IsNever<This> extends true
  ? false
  : e.IsNever<Type> extends true
  ? false
  : IsMaybeExactly<Type, This> extends true
  ? false
  : IsMaybe<Type, This> extends true
  ? boolean
  : [Type] extends [This]
...
type CheckBoolean<This, That, IfNotBoolean> = If<
  IsExactly<This, boolean>,
  boolean,
  If<IsExactly<That, boolean>, boolean, IfNotBoolean>
>;
// noinspection JSClassNamingConvention, JSUnusedGlobalSymbols
export type Or<This, That> = If<
  This,
  true,
  If<That, true, CheckBoolean<This, That, false>>
>;
// noinspection JSClassNamingConvention, JSUnusedGlobalSymbols
export type And<This, That> = If<
  Not<This>,
  false,
  If<Not<That>, false, CheckBoolean<This, That, true>>
>;

// noinspection JSUnusedGlobalSymbols, JSClassNamingConvention
export type Is<This, Type> = Or<
  IsGreaterOrEqual<This, Type>,
  IsLesser<This, Type> extends true ? boolean : IsLesser<This, Type>
>;

// noinspection JSUnusedGlobalSymbols
export type Requires<Any, Type, Union = never> = Is<Any, Type> extends true
  ? true
  : e.IsNever<Any> extends true
  ? e.IsNever<Union> extends true
    ? never
    : true
  : Maybe<Is<Any, Type>> extends true
  ? unknown
  : never;

// noinspection JSUnusedGlobalSymbols
export type Try<This, IfNotThat> = Not<e.IsNever<This>> extends true
  ? This
  : IfNotThat;
// noinspection JSUnusedGlobalSymbols
export type TryTrue<This, IfNotThat> = True<This> extends true
  ? This
  : True<IfNotThat> extends true
  ? IfNotThat
  : never;
...
if (environment.isDevelopment) {
  ...
  // noinspection JSUnusedLocalSymbols
  const toBooleanTestUnion: IsExactly<
    ToBoolean<string | undefined>,
    boolean
  > = true;
  // noinspection JSUnusedLocalSymbols
  const toBooleanTestUnionFalse: IsExactly<
  ...
  // noinspection JSUnusedLocalSymbols
  const ifTestBoolean: IsExactly<
    If<boolean, string, number>,
    string | number
  > = true;
  // noinspection JSUnusedLocalSymbols
  const ifTestUnion: IsExactly<
    If<string | undefined, string, number>,
    string | number
  > = true;
  // noinspection JSUnusedLocalSymbols
  ...
  // noinspection JSUnusedLocalSymbols
  const isExactlyTestAnyUnknown: IsExactly<
    IsExactly<any, unknown>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  const isExactlyTestAnyUnknownReverse: IsExactly<
    IsExactly<unknown, any>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  ...
  // noinspection JSUnusedLocalSymbols
  const isExactlyTestUnknown: IsExactly<
    IsExactly<unknown, number>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  const isExactlyTestUnknownType: IsExactly<
    IsExactly<number, unknown>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  ...
  // noinspection JSUnusedLocalSymbols
  const isExactlyTestUnrelated: IsExactly<
    IsExactly<string, number>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  const isExactlyTestUnionFalse: IsExactly<
    IsExactly<string | number, number | symbol>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  const isExactlyTestUnionTrue: IsExactly<
    IsExactly<string | number, number | string>,
    true
  > = true;
  // noinspection JSUnusedLocalSymbols
  ...
  // noinspection JSUnusedLocalSymbols
  const greaterTestNeverDouble: IsExactly<
    IsGreater<never, never>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  ...
  // noinspection JSUnusedLocalSymbols
  const greaterTestUnion: IsExactly<
    IsGreaterOrEqual<1 | 2, 2 | 3>,
    boolean
  > = true;

  // noinspection JSUnusedLocalSymbols
  const greaterOrEqualTestGreater: IsExactly<
    IsGreaterOrEqual<1, number>,
    true
  > = true;
  // noinspection JSUnusedLocalSymbols
  const greaterOrEqualTestEqual: IsExactly<
    IsGreaterOrEqual<number, number>,
    true
  > = true;
  // noinspection JSUnusedLocalSymbols
  const greaterOrEqualTestLesser: IsExactly<
    IsGreaterOrEqual<number, 1>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  const greaterOrEqualTestNever: IsExactly<
    IsGreaterOrEqual<never, 1>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  const greaterOrEqualTestNeverType: IsExactly<
    IsGreaterOrEqual<1, never>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  const greaterOrEqualTestNeverDouble: IsExactly<
    IsGreaterOrEqual<never, never>,
    true
  > = true;
  // noinspection JSUnusedLocalSymbols
  const greaterOrEqualTestAny: IsExactly<
    IsGreaterOrEqual<any, 1>,
    boolean
  > = true;
  // noinspection JSUnusedLocalSymbols
  const greaterOrEqualTestUnknown: IsExactly<
    IsGreaterOrEqual<unknown, 1>,
    boolean
  > = true;
  // noinspection JSUnusedLocalSymbols
  const greaterOrEqualTestAnyType: IsExactly<
    IsGreaterOrEqual<1, any>,
    true
  > = true;
  // noinspection JSUnusedLocalSymbols
  const greaterOrEqualTestUnknownType: IsExactly<
    IsGreaterOrEqual<1, unknown>,
    true
  > = true;
  // noinspection JSUnusedLocalSymbols
  const greaterOrEquaTestUnion: IsExactly<
    IsGreater<1 | 2, 2 | 3>,
    boolean
  > = true;

  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestGreater: IsExactly<
    IsLesserOrEqual<1, number>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestEqual: IsExactly<
    IsLesserOrEqual<number, number>,
    true
  > = true;
  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestLesser: IsExactly<
    IsLesserOrEqual<number, 1>,
    true
  > = true;
  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestNever: IsExactly<
    IsLesserOrEqual<never, 1>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestNeverType: IsExactly<
    IsLesserOrEqual<1, never>,
    false
  > = true;
  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestNeverDouble: IsExactly<
    IsLesserOrEqual<never, never>,
    true
  > = true;
  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestAny: IsExactly<IsLesserOrEqual<any, 1>, true> = true;
  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestUnknown: IsExactly<
    IsLesserOrEqual<unknown, 1>,
    true
  > = true;
  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestAnyType: IsExactly<
    IsLesserOrEqual<1, any>,
    boolean
  > = true;
  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestUnknownType: IsExactly<
    IsLesserOrEqual<1, unknown>,
    boolean
  > = true;
  // noinspection JSUnusedLocalSymbols
  const lesserOrEqualTestUnion: IsExactly<
    IsLesserOrEqual<1 | 2, 2 | 3>,
    boolean
  > = true;
  ...
  // noinspection JSUnusedLocalSymbols
  const tryStrictTestUnion: IsExactly<
    TryTrue<string | null, number>,
    number
  > = true;
  // noinspection JSUnusedLocalSymbols
  ...
  const isTestUnionNonExact: IsExactly<
    Is<number | string, 2 | 1 | symbol>,
    boolean
  > = true;
  // noinspection JSUnusedLocalSymbols, MagicNumberJS
  const isTestNonExact: IsExactly<Is<1 | 2 | 'a', number | 'a'>, true> = true;
  // noinspection JSUnusedLocalSymbols, MagicNumberJS, LocalVariableNamingConventionJS
  const isTestNonExactBoolean: IsExactly<
    Is<1 | 2 | 'a', symbol | 'a'>,
    boolean
  > = true;
  ...
  // noinspection JSUnusedLocalSymbols
  const requiresTestUnknown: IsExactly<
    Requires<unknown, number>,
    unknown
  > = true;
  // noinspection JSUnusedLocalSymbols
  const requiresTestNever: IsExactly<Requires<never, number>, never> = true;
  // noinspection JSUnusedLocalSymbols
  const requiresTestUnion: IsExactly<
    Requires<string | 1, number | symbol>,
    unknown
  > = true;
  // noinspection JSUnusedLocalSymbols
  const requiresTestUnionRequirement: IsExactly<
    Requires<1, number | symbol>,
    true
  > = true;
}
